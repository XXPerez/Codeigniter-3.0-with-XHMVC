...
// Log tracelines to profiler
$config['log_profiler'] = TRUE;
$config['firePHP'] = 'window';
...
|
*/
$config['error_views_path'] = APPPATH.'views/error/';
...
|
*/
$config['encryption_key'] = 'jkdsa89%&&/(ajsd76q37hxdqckl3';
...
include(strtolower(ENVIRONMENT).'/env_config.php');
